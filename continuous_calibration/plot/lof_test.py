"""CC Limit of Fitting Test Plotting"""
...
# Plot limit of fitting test results
def plot_lof_test(conc, test, threshold, conc_unit='moles_unit volume_unit^-1', f_format='svg',
                   save_to='', return_fig=False, return_img=False, transparent=False, font_size=12):
    [conc_unit] = units_adjust([conc_unit])
